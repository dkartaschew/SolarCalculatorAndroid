...
public class LocationData {
	 ...
	 *            Latitude(-90 > x > 90);
	 * @param name
	 *            Location Name (not null or "")
	 * @param locData
	 *            List of number of days each month that has cloud cover.
	 * @param locEfficiency
	 *            List of efficiency loss on days.
	 * @throws Exception
	 ...
	 *            A List of 12 months of the number of days of cloud cover
	 * @throws Exception
	 ...
	 * @param latitude
	 * @throws Exception
	 *             If the latitude supplied is invalid.
	 */
	 ...
	 * <CODE>set</CODE> method for the locationWeatherData property.
	 * 
	 * <p>
	 ...
	 * @param longitude
	 * @throws Exception
	 *             If the longitude supplied is invalid.
	 */
	...
	/**
	 * Basic ToString() method. DO NOT MODIFY THIS, as this is used by
	 * comboboxes for displaying location names;
	 * 
